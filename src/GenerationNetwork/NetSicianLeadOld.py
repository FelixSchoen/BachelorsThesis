...
class NetSicianLead:
    ...
    def start(self):
        ...
        while self.flag_active:
            try:
                element = (self.queue.get(True, 50))
    ...
    def setup(self):
        ...
        self.model = build_model(RNN_NODES)
        try:
...
VOCAB_SIZE = 200
EPOCHS = 7
RNN_NODES = [1024, 512, 512]


def build_model(rnn_units, batch_size=1, dropout=0.25, embedding_dim=3):
